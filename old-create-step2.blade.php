        ...
        <div class="card shadow-none position-relative overflow-hidden">
            <div class="card-body px-1 py-1">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <label for="product_quantity_target" class="form-label">Orders Quantity</label>
                                        ...
                                        <div class="col-4 childDiv border border-dark-subtle">
                                            <div class="mb-1">
                                                <select class="form-select selectingredientclass" id="input_id" name="input_id[]" onchange="getInputBatchPrice()">
                                                    <option value="select_option">Ingredientddd</option>
                                                    @foreach($ingredient_batches as $ingredient_batch)
                                                        @if ($ingredient_batch->input->type == "ingredient")
                                                            <option class="form-control" value="{{$ingredient_batch->input->id}}_{{$i}}" 
                                                                data-extra-price="{{$ingredient_batch->buying_price}}" 
                                                                data-extra-stock="{{$ingredient_batch->input->quantity_remaining}}">
                                                                {{$ingredient_batch->input->code}}/{{$ingredient_batch->batch_number}} :: {{$ingredient_batch->input->name}} -STH: {{number_format($ingredient_batch->quantity_remaining)}}
                                                            </option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-4 childDiv border border-dark-subtle">
                                            <div class="mb-1">
                                                <select class="form-select selectinputclass" id="input_id" name="packaging_id[]" onchange="getInputBatchPrice()">
                                                    <option value="select_option">Items</option>
