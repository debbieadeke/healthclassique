        ...
        <div class="card shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                ...
                <div class="card card-body">
                    ...
                    <form action="{{route('input-batch.update', [$inputbatch->id])}}" method="post" id="myForm">
                        @csrf
						@method('PATCH')
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="input_id" name="input_id" required onchange="updateFormLabels()">
                                        @foreach($inputs as $input)
                                            @if ($input->id == $inputbatch->input_id)
                                                <option class="form-control" value="{{$input->id}}" data-extra-type="{{$input->type}}" selected>{{$input->code}} ::  {{$input->name}}</option>
                                            @else
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="batch_number" name="batch_number" class="form-control" value="{{$inputbatch->batch_number}}" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="supplier_id" name="supplier_id" required>
                                        @foreach($suppliers as $supplier)
											@if ($supplier->id == $inputbatch->supplier_id)
												<option class="form-control" value="{{$supplier->id}}" selected>{{$supplier->name}}</option>
											@else
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="quantity_purchased" name="quantity_purchased" class="form-control" value="{{$inputbatch->quantity_purchased}}" min="0" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="buying_price" name="buying_price" class="form-control" value="{{$inputbatch->buying_price}}" required />
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" id="expiry_date" name="expiry_date" class="form-control" value="{{$inputbatch->expiry_date}}" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <button type="submit" class="btn btn-success" name="action" value="save_input_batch">Update Batch</button>
                        </div>
                    </form>
                </div>
            </div>
