    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('production-order.store') }}" method="post" id="myForm">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control select2" style="width: 100%; height: 40px" id="product_id"
                                    name="product_id" onchange="updateProdBatchDetails()">
                                    @foreach ($product_settings as $product_phase)
                                        @if ($product_phase->id == $product_setting_id)
                                            <option selected class="form-control" value="{{ $product_phase->id }}"
                                                data-extra-no_of_phases="{{ $product_phase->no_of_phases }}"
                                                data-extra-category="Ointment">{{ $product_phase->product->name }}</option>
                                        @else
                                            <option class="form-control" value="{{ $product_phase->id }}"
                                                data-extra-no_of_phases="{{ $product_phase->no_of_phases }}"
                                                data-extra-category="Ointment">{{ $product_phase->product->name }}</option>
                                        @endif
                                    @endforeach
                        ...
                        <div class="col-md-2" id="no_of_phases_div">
                            ...
                            <input type="text" class="form-control" id="no_of_phases" name="no_of_phases" readonly
                                value="{{ $no_of_phases }}">
                        </div>
                        <div class="col-md-2" id="rows_per_phase_div">
                            <label for="rows_per_phase" class="form-label">Rows / Phase</label>
                            <input type="text" class="form-control" id="rows_per_phase" name="rows_per_phase" readonly
                                value="{{ $rows_per_phase }}">
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" id="product_quantity_target"
                                name="product_quantity_target" value="{{ $product_quantity_target }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-2 align-items-end">
                            <a class="btn btn-danger" href="{{ route('production-order.create') }}" role="button">Restart
                                Process</a>
                        </div>
                    </div>
                </div>
                                ...
                                @for ($x = 1; $x <= $rows_per_phase; $x++)
                                    <div class="row border border-dark" id="originalDiv{{ $i }}">
                                        <div class="col-4 childDiv border border-dark-subtle">
                                            <div class="mb-1">
                                                <select class="form-select selectingredientclass" id="input_id"
                                                    name="input_id[]" onchange="getInputBatchPrice()">
                                                    ...
                                                    @foreach ($ingredient_batches as $ingredient_batch)
                                                        @if ($ingredient_batch->input->type == 'ingredient')
                                                            <option class="form-control"
                                                                value="{{ $ingredient_batch->input->id }}_{{ $i }}"
                                                                data-extra-price="{{ $ingredient_batch->buying_price }}"
                                                                data-extra-stock="{{ $ingredient_batch->input->quantity_remaining }}">
                                                                {{ $ingredient_batch->input->code }}/{{ $ingredient_batch->batch_number }}
                                                                :: {{ $ingredient_batch->input->name }} -STH:
                                                                {{ number_format($ingredient_batch->quantity_remaining) }}
                                                            </option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-1 childDiv border border-dark-subtle">
                                            <div class="mb-1">
                                                <input type="text" class="form-control percentageclass"
                                                    id="percentage{{ $i }}" name="percentage[]"
                                                    onchange="calculateItemGrammage()" value="0" />
                                            </div>
                                        </div>
                                        <div class="col-2 childDiv border border-dark-subtle">
                                            <div class="mb-1">
                                                <input type="text" class="form-control gramstobeaddedclass"
                                                    id="grams_to_be_added{{ $i }}" name="grams_to_be_added[]"
                                                    placeholder="0" value="0" style="background-color: #FA896B" />
                                            </div>
                                        </div>
                                        <div class="col-2 childDiv border border-dark-subtle">
                                            <div class="mb-1">
                                                <input type="text" class="form-control ingredientcostclass"
                                                    name="ingredient_cost[]" value="0"
                                                    onchange="calculateItemGrammage()" />
                                            </div>
                                        </div>
                                        <div class="col-2 childDiv border border-dark-subtle">
                                            <div class="mb-1">
                                                <input type="text" class="form-control ingredientformulaclass"
                                                    id="ingredient_cost_formula" name="ingredient_cost_formula[]"
                                                    placeholder="0" />
                                            </div>
                                        </div>
                                        <div class="col-1 childDiv border border-dark-subtle">
                        ...
                        @if ($incPackagingPhase == 'Yes')
                            ...
                            <div class="card-body">
                                ...
                                <div class="row border border-dark" id="originalDiv{{ $i }}">
                                    ...
                                    <div class="col-2 childDiv border border-dark-subtle">
                                        <div class="mb-1">
                                            <input type="text" class="form-control packsizeclass"
                                                id="packsize{{ $i }}" name="packsize[]"
                                                onfocusout="calculatePackagingBatchQty()" value="0" />
                                        </div>
                                    </div>
                                    <div class="col-1 childDiv border border-dark-subtle">
                                        <div class="mb-1">
                                            <input type="text" class="form-control batchqtyclass"
                                                id="batchqty{{ $i }}" name="batchqty[]" placeholder="0"
                                                value="0" style="background-color: #FA896B" />
                                        </div>
                                    </div>
                                    <div class="col-2 childDiv border border-dark-subtle">
                                        <div class="mb-1">
                                            <input type="text" class="form-control ingredientcostclass"
                                                name="ingredient_cost[]" value="100"
                                                onchange="calculatePackagingBatchQty()" />
                                        </div>
                                    </div>
                                    <div class="col-2 childDiv border border-dark-subtle">
                                        <div class="mb-1">
                                ...
                                <div class="row border border-dark" id="originalDiv{{ $i }}">
                                            ...
                                            <select class="form-select selectinputclass" id="input_id"
                                                ...
                                                @foreach ($packaging_batches as $ingredient_batch)
                                                    @if ($ingredient_batch->input->type == 'packaging')
                                                        <option class="form-control"
                                                            value="{{ $ingredient_batch->input->id }}_{{ $i + 2 }}"
                                                            data-extra-price="{{ $ingredient_batch->buying_price }}"
                                                            data-extra-qtydeterminant="{{ $ingredient_batch->input->quantity_determinant }}">
                                                            {{ $ingredient_batch->input->name }} (In Stock:
                                                            {{ number_format($ingredient_batch->quantity_remaining) }})
                                                        </option>
                                                    @endif
                                                @endforeach
                                    ...
                                    <div class="col-2 childDiv border border-dark-subtle">
                                        <div class="mb-1">
                                            <input type="text" class="form-control packsizeclass"
                                                id="packsize{{ $i }}" name="packsize[]"
                                                onchange="calculatePackagingBatchQty()" value="0" />
                                        </div>
                                    </div>
                                    <div class="col-1 childDiv border border-dark-subtle">
                                        <div class="mb-1">
                                            ...
                                            <select class="form-select selectinputclass" id="input_id"
                                                ...
                                                @foreach ($miscellaneous_batches as $ingredient_batch)
                                                    @if ($ingredient_batch->input->type == 'miscellaneous')
                                                        <option class="form-control"
                                                            value="{{ $ingredient_batch->input->id }}_{{ $i + 3 }}"
                                                            data-extra-price="{{ $ingredient_batch->buying_price }}">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <input type="text" class="form-control" id="total_batch_cost" name="total_batch_cost"
                        value="" readonly>
                </div>
                <div class="col-md-2">
                    <h4 class="card-title mb-0"><label for="total_batch_quantity" class="form-label text-end">Total Batch
                            Quantities</label></h4>
                </div>
                <div class="col-md-2">
                    <input type="text" class="form-control" id="total_batch_quantity" name="total_batch_quantity"
                        value="0" readonly>
                </div>
                <div class="col-md-1">
                ...
                <div class="col-md-4 d-grid gap-2 d-md-flex justify-content-md-end">
                    @if ($draft_production_orders == 'Enabled')
                        <button type="submit" name="save_draft" class="btn btn-warning save-draft-btn"
                            value="1">Save Draft</button>
                    @endif
                    <a href="{{ route('production-order.create') }}" class="btn btn-danger" role="button"
                        aria-disabled="true">Cancel Order Process</a>
                    <button type="submit" class="btn btn-success" name="action" value="order_submit">Submit
                        Order</button>
                </div>
            </div>
...
@section('extra-scripts')
    <script
        src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/libs/jquery.repeater/jquery.repeater.min.js">
    </script>
