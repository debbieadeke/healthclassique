            ...
            <div class="card-body">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="{{route('salescalls.list-cme')}}">CME Sales Calles</a> <i class="fas fa-angle-right"></i></li>
                    ...
                    <div class="card-body">
							...
							<div class="row">
								<div class="col-4">
									...
									<div class="mb-3">
										<label for="client_id" class="form-label"><b>Doctor</b></label>
										<input type="text" class="form-control readonly-label" value="{{$salescall->client->first_name}} {{$salescall->client->last_name}}">
									</div>
								</div>
                                <div class="col-4">
									<!-- Start Time -->
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control readonly-label" id="first_name" name="first_name" value="{{$salescalldetail->titles->name}}.  {{$salescalldetail->first_name}} {{$salescalldetail->last_name}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="contact" class="form-label"><b>Contact</b></label>
                                            <input type="text" class="form-control readonly-label" id="contact" name="contact" value="{{$salescalldetail->contact}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control readonly-label" id="discussion_summary" name="discussion_summary" rows="4">{{$salescalldetail->discussion_summary}}</textarea>
                                        </div>
                                    </div>
                                </div>
