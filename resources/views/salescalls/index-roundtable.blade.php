            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-3">
                            <form method="get" action="{{route('salescalls.list-roundtable')}}">
                                @csrf
                            ...
                            @if (count($salescalls) > 0)
                                @foreach($salescalls as $salescall)
                                    <tr>
                                        ...
                                        <td class="border-bottom-0">
                                            <a class="btn btn-primary m-1" href="{{ route('salescalls.show-roundtable', ['salescall' => $salescall->id]) }}" role="button">View Sales Call</a>
