    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post"  enctype="multipart/form-data" action="{{ route('salescalls.store-cme') }}">
							@csrf
							<div class="form-body">
							<!-- Select Pharmacy -->
							<div class="row">
								<div class="col-md-6">
									...
									<div class="mb-3">
										<label for="client_id" class="form-label"><b>Select Primary Doctor</b></label>
                            ...
                            <div class="form-actions">
                                <div class="text-end">
                                <input type="hidden" name="client_type" value="CME">
