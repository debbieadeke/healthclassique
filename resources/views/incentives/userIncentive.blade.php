...
@section('content-v2')
    <div class="container planner">
        <div class="card text-bg-light">
            <div class="card-body">
                <h3>Reps Incentive</h3>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a> <i class="fas fa-angle-right"></i></li>
                        <li class="breadcrumb-item active" aria-current="page">Reps Incentive</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <h5 class="card-title fw-semibold mb-4">
                            {{$user->first_name}} {{$user->last_name}} {{$pagetitle}}
                        </h5>
                    </div>
                    <div class="col-md-4">
                        <form>
...
{{--                                </div>--}}
                                ...
                                <!-- Final incentive -->
                                <div class="text-end mb-2">
                                    <h4><b>Total Quarter Incentive Earned:</b> {{ number_format($finalIncentive, 2, '.', ',') }}</h4>
                                </div>
                            </div>
                        </div>
                </div>
