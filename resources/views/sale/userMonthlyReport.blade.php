                        ...
                        <div class="p-2">
                            <table class="table table-responsive table-dash mb-0 border-0 display">
                                        ...
                                        <td>
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="{{ route('sale.userMonthlyFacilities', ['userId' => $user_id, 'productCode' => $item['product_code'],'month'=>$currentMonth, 'year'=>$currentYear]) }}">
                                ...
                                <tr style="font-weight: bold;">
                                    ...
                                    <td style="font-weight: bold;">{{ number_format($achievedPriceTotal, 2, '.', ',') }}</td>
