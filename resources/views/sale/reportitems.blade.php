                        ...
                        <div class="table-responsive">
                            <table  class="table mb-0 border-0 datatable custom-table table-striped">
                                        ...
                                        <td>
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="{{ route('sale.reportfacilities', ['userId' => $user_id, 'productCode' => $item['product_code'], 'filter_start_date' => $filter_start_date, 'filter_end_date' => $filter_end_date]) }}">
                                ...
                                <tr style="font-weight: bold;">
                                    ...
                                    <td class="text-info-emphasis" style="font-weight: bold;">{{ $totalTargetValue != 0 ? number_format(($achievedPriceTotal / $totalTargetValue ) * 100, 0) : 0 }}%</td> <!-- Percentage Performance Average -->
                                    <td></td>
                                </tr>
                                </tbody>
                            </table>
