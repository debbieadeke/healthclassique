            ...
            <div class="card-body">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Full Sales Items</li>
                    </ol>
                </nav>
            </div>
        </div>
                                                            ...
                                                            <td>
                                                                <div class="dropdown dropdown-action">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <a class="dropdown-item" href="{{ route('sale.fullReportfacilities', ['userId' => $user_id, 'productCode' => $item['product_code']]) }}">
