...
@section('content-v2')
    <div class="container planner">
        <div class="card text-bg-light">
            <div class="card-body">
                <h3>update user Samples Inventory</h3>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="sampleInventory" method="post" action="{{ route('sample-batch.updateUseInventory', ['id' =>  $sample->id]) }}">
                            @csrf
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="quantity" name="quantity" min="1" value="{{$sample->quantity}}" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
