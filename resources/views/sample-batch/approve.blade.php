                                    ...
                                    <table class="table mb-0 border-0 custom-table" id="sampleBatchTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width:20%">Quantity <br> Approved</th>
                                                <th></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($products as $product)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="col-md-4">
                                                            <input type="number" min="0" class="form-control form-control-sm" size="1" name="product_qty[]" value="{{ $product->quantity_requested }}">
                                                        </div>
                                        ...
                                        <tfoot>
                                            ...
                                            <td colspan="2"></td>
                                            <td colspan="1"></td>
                                            <td colspan="1"><button type="submit" class="btn btn-success" name="action" value="store_cme_submit">Approve</button></td>
                                        </tfoot>
                                    </table>
                                </div>
                            </div>
