...
@section('content-v2')
    <div class="container-fluid">
        <div class="card bg-light-info position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Samples Invoicing</h4>
        ...
        <div class="card shadow-none position-relative overflow-hidden">
            <form action="{{route('sample-batch.invoiced')}}" method="post" id="myForm">
                @csrf
                <div class="col-12 col-md-12  col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="card-title d-inline-block">Invoice Sample Requests</h4>
                                </div>
                                <div class="col-md-4">
                                ...
                                <table class="table mb-0 border-0 custom-table" id="sampleBatchTable">
                                    ...
                                    @foreach($products as $product)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-md-6">
                                                    <input type="number" min="0" max="{{$product->quantity_approved}}" class="form-control form-control-sm" size="1" name="product_qty[]" value="{{ $product->quantity_approved }}">
                                                </div>
                                    ...
                                    <td colspan="1"></td>
                                    <td colspan="1"></td>
                                    <td colspan="1"><button type="submit" class="btn btn-success" name="action" value="store_cme_submit">Invoice</button></td>
                                    </tfoot>
                                </table>
                            </div>
                        </div>
