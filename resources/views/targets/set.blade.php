...
@section('content-v2')
    <div class="container-fluid">
                    ...
                    <div class="col-9">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="">Pharmacy Sales Target</a> <i class="fas fa-angle-right"></i></li>
        ...
        <div class="card shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <form action="{{route('targets.store',['id' => $product->first()->id, 'code' => $code]) }}" method="post" id="myForm">
                    <div class="row">
                        <div class="col-md-4">
