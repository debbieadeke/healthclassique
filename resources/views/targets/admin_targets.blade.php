    ...
    <div class="container">
            ...
            <div class="card-body">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Sales Rep Target</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-10">
                        <h5 class="card-title"><b>{{ $user_name }}</b> targets for <b>{{ $name }} ({{ $currentYear }}) </b></h5>
                    </div>
                ...
                <div class="p-2">
                    ...
                    <div class="p-2">
                        <table class="table table-responsive table-dash mb-0 border-0 display" id="myDataTable">
                                        ...
                                        <td class="text-end">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="{{ route('targets.edit_admin',['id' =>$product->id, 'code' => $code, 'user'=>$user_id,'type'=>$type]) }}"><i class="fas fa-square-plus" style="color:green; font-size: 18px;"></i> Edit Target</a>
