...
@section('content-v2')
    <div class="container">
        <div class="card text-bg-light">
            <div class="card-body">
                <h1>Users Sales Target</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('home')}}">Dashboard</a> <i class="fas fa-angle-right"></i></li>
                        <li class="breadcrumb-item active" aria-current="page">Select a Pharmacy</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Set Targets for My Pharmacy <b></b></h5>
                <div class="card-body px-4 py-3">
                    <form action="{{route('targets.pharmacy_targets') }}" method="post" id="myForm">
                        <div class="row">
                            <div class="col-md-6">
                                <label for="customer" class="form-label">Select a Pharmacy</label>
