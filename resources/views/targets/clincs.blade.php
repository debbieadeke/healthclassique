    ...
    <div class="container">
            ...
            <div class="card-body">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Clinics Sales Target</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-10">
                        <h5 class="card-title">My Clinics targets for  <b>{{ $name }} {{ $currentYear }} </b></h5>
                    </div>
                ...
                <div class="p-2">
                    ...
                    <div class="p-2">
                        <table class="table table-responsive mb-0 border-0 display" id="myDataTable">
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="{{ route('targets.set_clinic',['id' =>$product->id, 'code' => $code]) }}"><i class="fas fa-square-plus" style="color:green; font-size: 18px;"></i> Set Target</a>
                                                     <a class="dropdown-item" href="{{ route('targets.edit_clinic',['id' =>$product->id, 'code' => $code]) }}"><i class="fas fa-edit" style="color:deepskyblue; font-size: 18px;"></i>Edit Target</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            @else
                                <tr>
                                    <td class="border-bottom-0" colspan=6><h6 class="fw-semibold mb-0">No Products Check If you are Assigned to a Team/ Selected your products in this clinc </h6></td>
                                </tr>
                            @endif
                            </tbody>
                        </table>
