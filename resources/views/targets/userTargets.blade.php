        ...
        <div class="row">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title fw-semibold">Monthly Targets</h5>
                    <div class="filter-section d-flex">
                        <form id="filterForm" action="{{route('targets.monthlyTargetsFilters',['userId' => $user_id])}}" method="GET" class="d-flex">
                            <div class="mb-3 me-3">
                            ...
                            <div class="form-body">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="p2">
                                            <div class="p-2">
                                                <table class="table table-responsive mb-0 border-0 display"  data-page-length="-1">
                                                    <thead>
                                                            ...
                                                            <td>
                                                                <div class="dropdown dropdown-action">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <a class="dropdown-item" href="{{ route('targets.monthlyTargets', ['userId' => $user_id, 'productCode' => $item['product_code'],'month'=>$currentMonth, 'year'=>$currentYear]) }}">
                                                                            <i class="fa-solid fa-eye m-r-5" style="color:#0D0A0A; font-size: 12px;"></i>View
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </td>
