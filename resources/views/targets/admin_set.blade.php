...
@section('content-v2')
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Targets for <b>{{ $currentYear }}</b></h5>
                                    ...
                                    <tr>
                                        ...
                                        @for ($quarter = 1; $quarter <= 3; $quarter++)
                                            <td>
                                                ...
                                                @else
                                                    <span class="status-red" style="padding:4px; border-radius:8px">0</span>
                                                @endif
                                            </td>
                                        @endfor
                                        <td class="text-end">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href=""><i class="fas fa-square-plus" style="color:green; font-size: 18px;"></i> Set Target</a>
