    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{ route('planner.store-pharmacy-appointment') }}">
							@csrf
							<div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        ...
                                        <div class="mb-3">
                                            <label for="client_id" class="form-label">Select Pharmacy</label>
                                    ...
                                    <div class="container p-3">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <input type="text" class="form-control" id="newpharmacyname" name="newpharmacyname">
                                            </div>
                                            <div class="col-md-2">
