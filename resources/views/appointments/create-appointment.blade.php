                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control select2" style="width: 100%; height: 40px" id="client_id" name="client_id" required onchange="getUserDetails()">
                                                ...
                                                @if (isset ($client->$specialities))
                                                    ...
                                                    <option class="form-control" value="{{$client->id}}" data-extra-info="{{$client->specialities->name}}" data-extra-class="{{$client->titles->name}}">{{$client->titles->name}}.  {{$client->first_name}} {{$client->last_name}}
                                                        @if ($visited_today)
                                                            (Visited today)
                                                        @endif
                                                        @if ($in_appointment)
                                    ...
                                    <div class="col-md-1">
                                        <div id="class_div" style="flex-direction: column;">
                                            <label for="myclass" class="form-label"><b>Title</b></label>
