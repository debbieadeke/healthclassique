    ...
    <div class="card card-default">
        <div class="card-header clearfix">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Create New Client</h4>
        ...
        <div class="card shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <form action="{{route('client-users.store-clients')}}" method="post" id="myForm">
                    <div class="row pt-2">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="first_name" placeholder="John" name="first_name" value="" required>
                        </div>
                        <div class="col-md-4">
                            <label for="last_name" class="form-label">Last Name</label>
                            <input type="text" class="form-control" id="last_name" placeholder="Doe" name="last_name" value="" required>
                        </div>
                    ...
                    <div class="row pt-2">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="category" placeholder=" Doctor" name="category" value="" required>
                        </div>
                        <div class="col-md-4">
