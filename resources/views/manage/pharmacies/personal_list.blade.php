    ...
    <div class="card card-default">
        ...
        <div class="card-header clearfix">
            ...
            <div class="float-start">
                <h4 class="mt-5 mb-5"><a href="{{ route('pharmacy-users.index', ['facility_type' => $facility_type])}}">All Clients</a> | Manage Your {{$pagecategory}} List</h4>
            </div>
            ...
            <div class="table-responsive">
                ...
                <table class="table">
                    ...
                    @foreach($allclients as $key => $client)
                        ...
                        ?>
                        <form method="post" action="{{ route('personal-pharmacy-users.update') }}">
                            @csrf
                        <tr>
                            ...
                            <td style="vertical-align: top">
                                <input type="hidden" name="client_id" value="{{$client->id}}"><button type="submit" class="btn btn-primary" name="action">Update</button>
                            </td>
                        </tr>
                        </form>
						@endif
