    ...
    <div class="card card-default">
        ...
        <div class="card-header clearfix">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Create New Pharmacy</h4>
        ...
        <div class="card shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <form action="{{route('pharmacy-location.store')}}" method="post" id="myForm">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Pharmacy Name" name="name" value="" required>
                        </div>
                            <div class="col-md-4">
