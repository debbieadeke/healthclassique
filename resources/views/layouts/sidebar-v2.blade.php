...
{{--                    <span class="nmbr">{{$ordersBookedCount}}</span>--}}
        ...
        <li class="submenu">
            ...
            <ul style="display: none;">
{{--                <li><a class="dropdown-item" href="{{route('sample-batch.create')}}">Request Samples</a></li>--}}
                <li><a class="dropdown-item" href="{{route('sample-batch.request-sample')}}">Request Samples</a></li>
                <li><a class="dropdown-item" href="{{route('sample-batch.user-sample-inventory')}}">Samples Inventory</a></li>
        ...
        <li class="submenu">
            ...
            <ul style="display: none;">
                <li><a class="dropdown-item" href="{{route('planner.userCalender')}}">View Planner</a></li>
                <li><a class="dropdown-item" href="{{route('planner.create-appointment')}}">Add Doctor Appt</a></li>
                <li><a class="dropdown-item" href="{{route('planner.create-pharmacy-appointment')}}">Add Pharmacy Appt</a></li>
                <li><a class="dropdown-item" href="{{route('planner.create-facility-appointment')}}">Add Clinic Appt</a></li>
                <li><a class="dropdown-item" href="{{route('planner.list-appointments')}}">Reschedule Appt</a></li>
            </ul>
        </li>
{{--        <li class="submenu">--}}
...
{{--            <ul style="display: none;">--}}
{{--                <li><a class="dropdown-item" href="{{ route('incentive.salesrep-index') }}">My Incentive</a></li>--}}
{{--            </ul>--}}
{{--        </li>--}}
        <li class="submenu">
