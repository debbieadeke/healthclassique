$(function() {
	...
	new Chart(ctx4, {
		...
		data: {
			...
			datasets: [{
				label: 'Sales',
				data: [14, 12, 34, 25, 24, 20],
				backgroundColor: ['#37429b', '#47ec8d', '#38cb89', '#3e80eb', '#ffab00', '#ef4b4b']
			}]
		},
		options: {
			indexAxis: 'y',
	...
	new Chart(ctx5, {
		...
		data: {
			...
			datasets: [{
				data: [14, 12, 34, 25, 24, 20],
				backgroundColor: [ '#37429b', '#47ec8d', '#116e7c', '#ffab00', '#ef4b4b']
			}, {
